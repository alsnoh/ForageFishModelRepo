                                    ...
                                    z) 
{
    ...
    ####################################### Combine submodels and calculate growth ###########################################
        ...
        {   
            ...
            M_daily <- M_daily + 1/24 * (fitness_partic * MET_SMR * exp(swimming_speed*LENGTH * 0.02) + fitness_filter * MET_SMR * exp(filter_speed[h]*LENGTH * 0.02)) / (fitness_partic + fitness_filter)
